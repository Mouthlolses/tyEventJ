package com.revenuee.tyeventj.ui.theme
...
private val LocalCaririPlusColors = staticCompositionLocalOf<CaririPlusColors> {
    error("No JetsnackColorPalette provided")
}
private val LightColorPalette = CaririPlusColors(
    brand = Shadow5,
...
private val DarkColorPalette = CaririPlusColors(
    brand = Shadow1,
...
fun CaririPlusTheme(
    ...
    ProvideCaririPlusColors(colors) {
        MaterialTheme(
...
object CaririPlusTheme {
    val colors: CaririPlusColors
        @Composable
        get() = LocalCaririPlusColors.current
}

@Immutable
data class CaririPlusColors(
...
@Composable
fun ProvideCaririPlusColors(
    colors: CaririPlusColors,
    content: @Composable () -> Unit
) {
    CompositionLocalProvider(LocalCaririPlusColors provides colors, content = content)
}
